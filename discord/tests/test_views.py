...
class TestDiscordRefreshURL(TestCase):
    def setUp(self):
        self.expired_url = "https://cdn.discordapp.com/attachments/858938620425404426/1248453128991412224/animemoeus-waifu.jpg"
    ...
    def test_refresh_expired_url(self, mock_refresh):
        mock_refresh.return_value = (
            "https://cdn.discordapp.com/attachments/refreshed-url.jpg"
        )
        ...
        self.assertEqual(  # noqa: PT009
            response.url, "https://cdn.discordapp.com/attachments/refreshed-url.jpg"
        )
    ...
    def test_refresh_invalid_url(self, mock_refresh):
        ...
        self.assertEqual(response.status_code, 444)  # noqa: PT009
